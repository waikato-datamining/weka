...
public class CfsSubsetEval extends ASEvaluation implements SubsetEvaluator,
  ...
  private float correlate(int att1, int att2) throws Exception {
  ...
  private double symmUncertCorr(int att1, int att2) throws Exception {
    int i, j, ii, jj;
    int ni, nj;
    double sum = 0.0;
    double sumi[], sumj[];
  ...
  private double num_num(int att1, int att2) throws Exception {
    int i;
    Instance inst;
  ...
  private double num_nom2(int att1, int att2) throws Exception {
    int i, ii, k;
    double temp;
    Instance inst;
    if (Thread.currentThread().isInterrupted()) throw new InterruptedException();
  ...
  private double nom_nom(int att1, int att2) throws Exception {
    int i, j, ii, jj, z;
    double temp1, temp2;
    Instance inst;
    if (Thread.currentThread().isInterrupted()) throw new InterruptedException();
  ...
  private void addLocallyPredictive(BitSet best_group) throws Exception {
    int i, j;
    boolean done = false;
    boolean ok = true;
