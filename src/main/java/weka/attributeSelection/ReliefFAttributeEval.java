...
public class ReliefFAttributeEval extends ASEvaluation implements
   ...
   */
  private void updateWeightsNumericClass(int instNum) throws Exception {
    int i, j;
    double temp, temp2;
    int[] tempSorted = null;
   ...
   * @param instNum the index of the instance to use when updating weights
   */
  private void updateWeightsDiscreteClass(int instNum) throws Exception {
    int i, j, k;
    int cl;
   ...
   */
  private void findKHitMiss(int instNum) throws Exception {
    int i, j;
    int cl;
    double ww;
