...
public class SplashWindow extends Window {
  ...
  public static void invokeMain(String className, String[] args) {
    try {
      if (className.equals("weka.gui.GUIChooserApp")) {
        weka.gui.GUIChooserApp.main(args);
      } else if (className.equals("weka.gui.Workbench")) {
        weka.gui.Workbench.main(args);
      } else if (className.equals("weka.gui.knowledgeflow.KnowledgeFlowApp")) {
        weka.gui.knowledgeflow.KnowledgeFlowApp.main(args);
      } else if (className.equals("weka.gui.beans.KnowledgeFlowApp")) {
        weka.gui.beans.KnowledgeFlowApp.main(args);
      } else { // Resort to reflection as a last attempt (will break across module boundaries if module not opened)
