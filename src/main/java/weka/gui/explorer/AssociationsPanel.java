      ...
      m_RunThread = new Thread() {
        ...
        public void run() {
          ...
          try {
            ...
            // fall-through to finally for UI/cleanup
          } catch (Exception ex) {
            ex.printStackTrace();
            m_Log.logMessage(ex.getMessage());
            JOptionPane.showMessageDialog(AssociationsPanel.this,
                    "Problem running associator:\n" + ex.getMessage(),
                    "Running associator", JOptionPane.ERROR_MESSAGE);
            m_Log.statusMessage("Problem running associator");
          } finally {
