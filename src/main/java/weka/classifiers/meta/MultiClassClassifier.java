...
public class MultiClassClassifier 
  ...
  private class RandomCode 
     ...
     */
    public RandomCode(int numClasses, int numCodes, Instances data) throws Exception {
  ...
  private class ExhaustiveCode 
     ...
     * @param numClasses the number of classes
     */
    public ExhaustiveCode(int numClasses) throws Exception {
   ...
   */
  public static double[] pairwiseCoupling(double[][] n, double[][] r) throws Exception {
