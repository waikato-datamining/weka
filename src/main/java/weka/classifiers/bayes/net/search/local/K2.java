...
public class K2 extends LocalScoreSearchAlgorithm implements
  ...
  public void search(BayesNet bayesNet, Instances instances) throws Exception {
    ...
    for (int iOrder = 1; iOrder < instances.numAttributes(); iOrder++) {
      ...
      if ((iOrder & 0xFF) == 0 && Thread.currentThread().isInterrupted()) throw new InterruptedException();
    ...
    for (int iOrder = 1; iOrder < instances.numAttributes(); iOrder++) {
      ...
      while (bProgress) {
        ...
        for (int iOrder2 = 0; iOrder2 < iOrder; iOrder2++) {
          ...
          if ((iOrder2 & 0xFF) == 0 && Thread.currentThread().isInterrupted()) throw new InterruptedException();
