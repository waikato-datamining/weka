...
public class HillClimber extends LocalScoreSearchAlgorithm {
  ...
  void initCache(BayesNet bayesNet, Instances instances) throws Exception {
    ...
    for (int iAttributeHead = 0; iAttributeHead < nNrOfAtts; iAttributeHead++) {
      ...
      if ((iAttributeHead & 0xFF) == 0 && Thread.currentThread().isInterrupted()) throw new InterruptedException();
   ...
   */
  void updateCache(int iAttributeHead, int nNrOfAtts, ParentSet parentSet) throws Exception {
    ...
    for (int iAttributeTail = 0; iAttributeTail < nNrOfAtts; iAttributeTail++) {
      ...
      if ((iAttributeTail & 0xFF) == 0 && Thread.currentThread().isInterrupted()) throw new InterruptedException();
